...
const SERIES_CHARACTERS_QUERY = `
  query ($id: Int, $perPage: Int) {
    Media(id: $id) {
      characters(sort: [ROLE, FAVOURITES], perPage: $perPage) {
        nodes {
          id
          name {
            full
 ...
 * AniList numeric id, ranked main-role-first then by favourites. Each
 * character has `id`, `name` (full name string), and `image` (large
